...
bdfl_delegate: Brett Cannon <brett@python.org>
...
source_path: https://github.com/python/peps/blob/main/peps/pep-0629.rst
source_commit: 016b650310e837142acc41db3d23d43d269d5634
---
...
This PEP was [accepted on
2020-08-20](https://discuss.python.org/t/pep-629-versioning-pypis-simple-api/4720/15).
PyPI [merged an
implementation](2bfa5a8c75e3af218494fe8de1eb809a43e3bbb9) on 2020-01-28,
marking this PEP as \"Final\".
::::
...
of \"pypi:repository-version\", and a content that is a
`440`{.interpreted-text role="pep"} compatible version number, which is
further constrained to ONLY be Major.Minor, and none of the additional
features supported by `440`{.interpreted-text role="pep"}.
