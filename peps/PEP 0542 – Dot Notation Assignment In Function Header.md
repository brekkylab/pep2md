...
author:
- Markus Meskanen <markusmeskanen@gmail.com>
status: Rejected
...
source_path: https://github.com/python/peps/blob/main/peps/pep-0542.rst
source_commit: 14c75f0d53042d694059afad1720370d13db8002
---
...
instance attribute directly in the function definition\'s header by
using the dot notation to separate the object from the function\'s name.
...
the time of the function definition what it\'s goig to be used for. It
also saves one line of code while removing visual complexity.

The feature would also avoid leaving the function\'s name into the
global namespace:
