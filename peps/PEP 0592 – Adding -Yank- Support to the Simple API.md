...
source_path: https://github.com/python/peps/blob/main/peps/pep-0592.rst
source_commit: 5ef853a583258d9f58cd6e37eefa8e83a3ae2167
---
...
that a while ago, and now a computer is just continuing to mechanically
...
1.  Yanked files are always ignored, unless they are the only file that
    ...
    done as per `440`{.interpreted-text role="pep"} for things like
    local versions, zero padding, etc.
