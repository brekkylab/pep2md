...
source_path: https://github.com/python/peps/blob/main/peps/pep-0556.rst
source_commit: d3376acc62baa833596749eebbf35cccbdc2758a
---
...
- `gc.set_mode(mode)` sets the current mode of operation (either
  ...
  mode is \"threaded\", then the function also waits for the GC thread
  to end.
