...
source_path: https://github.com/python/peps/blob/main/peps/pep-0330.rst
source_commit: 998d5a0cc8d0afd51a0de8af2c87892ea79501a5
---
...
measure, its value is somewhat limited because perfectly valid bytecode
can still do horrible things. That situation could change if the concept
of restricted execution were to be successfully resurrected.
...
2[^1], Sections 4.8 and 4.9 were therefore used as a basis for some of
the constraints explained below. Any Python bytecode verification
...
objects. It verifies that the object\'s bytecode is well-formed
according to the specifications of this PEP.
