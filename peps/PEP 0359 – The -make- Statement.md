...
source_path: https://github.com/python/peps/blob/main/peps/pep-0359.rst
source_commit: 197aaa93ebeb38438c0047b306de0db25f6a9b90
---
...
Zope+Plone code[^9] revealed that `create` would break a lot more code,
so `make` was adopted as the keyword instead. However, there are still a
...
## Removing \_\_metaclass\_\_ in Python 3000
