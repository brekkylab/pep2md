...
source_path: https://github.com/python/peps/blob/main/peps/pep-0584.rst
source_commit: 4ffc4f1d1580f0fcb0a025c1b1ed730f0557f453
---
...
- Would likely require a new kind of method decorator which combined the
  ...
  override the method. There is a [proof of
...
- It isn\'t an operator. Guido discusses [why operators are
  ...
  For another viewpoint, see [Alyssa Coghlan\'s blog
...
long, complex single expressions, possibly well over the
`8`{.interpreted-text role="pep"} maximum line length of 80 columns. As
with any other language feature, the programmer should use their own
judgement about whether `|` improves their code.
