...
bdfl_delegate: Pablo Galindo Salgado <pablogsal@python.org>
status: Final
...
source_path: https://github.com/python/peps/blob/main/peps/pep-0626.rst
source_commit: 1d8b54ae6c8099193a1cd1b569ce16a7af1d4a59
---
...
code object. For reliable operation, `linetable` should be copied into a
local buffer before calling `PyLineTable_InitAddressRange`.
::::
