...
source_path: https://github.com/python/peps/blob/main/peps/pep-3126.rst
source_commit: 274865e47f238b620e3578eebbce0575a7db45a6
---
...
> behavior even if you *are* a Python programmer, and not everyone here
> is.

# Solution

In Python, strings are objects and they support the \_\_add\_\_
operator, so it is possible to write:

    "abc" + "def"

Because these are literals, this addition can still be optimized away by
the compiler; the CPython compiler already does so. [^2]
...
Guido indicated[^3] that this change should be handled by PEP, because
...
limits messages to 2048 characters[^7], which is less than Python\'s
...
least `xgettext`[^8] in particular?
...
[^1]: Implicit String Concatenation, Orendorff
...
[^3]: Reminder: Py3k PEPs due by April, Hettinger, van Rossum
    <https://mail.python.org/pipermail/python-3000/2007-April/006563.html>
...
[^5]: (email Subject) PEP 30XZ: Simplified Parsing, Skip,
    <https://mail.python.org/pipermail/python-3000/2007-May/007261.html>

[^6]: (email Subject) PEP 30XZ: Simplified Parsing
    <https://mail.python.org/pipermail/python-3000/2007-May/007305.html>

[^7]: Unix man page for xgettext \-- Notes section
    <http://www.scit.wlv.ac.uk/cgi-bin/mansec?1+xgettext>

[^8]: GNU gettext manual <http://www.gnu.org/software/gettext/>
