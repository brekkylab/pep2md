...
source_path: https://github.com/python/peps/blob/main/peps/pep-0485.rst
source_commit: 44660ff8d4b3feb8799920f8c49710cf08e346af
---
...
- `complex`: For complex, a companion function will be added to the
  ...
  scaling and comparison. If a complex tolerance is passed in, the
...
(Boost refers to these as the \"weak\" and \"strong\" formulations[^4])
...
python float). The value of 1e-9 was selected because it is the largest
...
zero, but not \"close\" to an even smaller value. e.g., 1e-10 is
\"close\" to zero, but not \"close\" to 1e-11.
...
[^1]: 1976\. R. H. Lathwell. APL comparison tolerance. Proceedings of
