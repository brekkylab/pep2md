...
source_path: https://github.com/python/peps/blob/main/peps/pep-0567.rst
source_commit: adaa1b167e1702415ffe866b4713d24906df5868
---
...
`567`{.interpreted-text role="pep"} was accepted by Guido on Monday,
January 22, 2018[^6]. The reference implementation was merged on the
same day.
...
[^2]: `550#appendix-hamt-performance-analysis`{.interpreted-text
    role="pep"}

[^3]: `550#replication-of-threading-local-interface`{.interpreted-text
    role="pep"}
