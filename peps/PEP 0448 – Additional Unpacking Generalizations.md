...
source_path: https://github.com/python/peps/blob/main/peps/pep-0448.rst
source_commit: 0bbc20ae8ad81c4a2ccc020b0d4576e7bde44d88
---
...
positions, an arbitrary number of times, and in function calls and
displays.
...
provided through multiple `**` unpackings, e.g.
`f(**{'x': 2}, **{'x': 3})`, except that the error will be detected at
runtime.
...
An implementation for Python 3.5 is found at Issue 2292 on bug
tracker[^2]. This currently includes support for unpacking inside
