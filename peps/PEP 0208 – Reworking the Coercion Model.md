...
source_path: https://github.com/python/peps/blob/main/peps/pep-0208.rst
source_commit: 34bbe2d96b0f227a3cd3ab5a1f2620cf1f8d2658
---
...
- since the coercion method is not being told about the operation that
  ...
  coercion of types,
- there is no elegant way to solve situations were a common type is not
  at hand, and
...
flux since it should take into account rich comparisons (i.e.
`207`{.interpreted-text role="pep"}).\]
