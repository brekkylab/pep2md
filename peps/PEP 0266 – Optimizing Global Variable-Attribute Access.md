...
source_path: https://github.com/python/peps/blob/main/peps/pep-0266.rst
source_commit: 24316f10b15d5c918fd62a987a32da022c967e04
---
...
and it was the responsibility of \"external forces\" outside the
...
about this. If you look at the code that implements the `STORE_GLOBAL`
and `STORE_ATTR` opcodes, it seems likely that some changes will be
...
you get into issues of modifying `STORE_FAST` as well, which could be a
problem, since the name bindings for local variables are changed much
