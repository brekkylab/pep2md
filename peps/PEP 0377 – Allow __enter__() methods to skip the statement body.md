...
source_path: https://github.com/python/peps/blob/main/peps/pep-0377.rst
source_commit: 8ea805188cffff4c783febe655e20c7a9c9faa67
---
...
corresponding nested `with` statements would not[^1].
...
examples above would then \"just work\", but the class based version
would need a small adjustment to take advantage of the new semantics:
