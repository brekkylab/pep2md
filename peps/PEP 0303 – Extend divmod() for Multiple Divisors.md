...
- Anglo-Saxon length units: 1 mile = 1760 yards, 1 yard = 3 feet, 1 foot
  = 12 inches.
- Anglo-Saxon weight units: 1 long ton = 160 stone, 1 stone = 14 pounds,
  1 pound = 16 ounce, 1 ounce = 16 dram.
...
and thus gets a return value with an \"unknown\" number of elements,
would otherwise have to special case that case. Code that *knows* it is
