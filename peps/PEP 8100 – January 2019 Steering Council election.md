...
`13`{.interpreted-text role="pep"}. This is the first steering council
election.
...
outgoing steering council, and `13`{.interpreted-text role="pep"} says
that the returns officer is instead appointed by the PSF Executive
Director, Ewa Jodlowska. [She appointed Ee
Durbin](https://discuss.python.org/t/officially-appointing-the-returns-officer-for-the-steering-council-election/603).
