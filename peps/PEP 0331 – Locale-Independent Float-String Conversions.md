...
source_path: https://github.com/python/peps/blob/main/peps/pep-0331.rst
source_commit: ad002600ca31b9a40ed9741728c7a31c4ff02cf1
---
...
that the `setlocale()` function also presents thread-safety issues,
...
`LC_NUMERIC` is not set at the libc level, float values are displayed
incorrectly (using \'.\' as a separator) in the spinbutton\'s text
entry, and it is impossible to enter fractional values using the \',\'
separator.
...
The final patch[^10] was integrated into Python CVS by Martin v. Löwis
on 2004-06-08, as stated in the bug report.
...
[^4]: GNOME bug report,
    <http://bugzilla.gnome.org/show_bug.cgi?id=114132>
