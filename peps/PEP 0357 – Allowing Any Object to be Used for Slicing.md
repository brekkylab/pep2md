...
source_path: https://github.com/python/peps/blob/main/peps/pep-0357.rst
source_commit: 4d35a6a27738b2933c59790804cb61fcc09c64b9
---
...
better name emerged. See the discussion thread[^1] for examples of names
that were suggested such as \"`__discrete__`\" and \"`__ordinal__`\".
...
[^1]: Travis Oliphant, PEP for adding an sq_index slot so that any
