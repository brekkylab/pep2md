...
source_path: https://github.com/python/peps/blob/main/peps/pep-0329.rst
source_commit: 0a82497f645c5e469efc91751d3be163c5f17c99
---
...
6.  Are you the first person to recognize that most global lookups are
    ...
    explanation in `266`{.interpreted-text role="pep"}.
...
have bytecodes[^1]. In that situation, the bind functions would simply
