...
source_path: https://github.com/python/peps/blob/main/peps/pep-0286.rst
source_commit: 72aeeb6d696c0766b84d49a3fd19171e14bb2d98
---
...
`426`{.interpreted-text role="pep"}, which proposes the use of a
preprocessing step to generate some aspects of C API interface code.
...
tuple, adding an `__dict__` member (at `tp_dictoffset` -4). Instances of
