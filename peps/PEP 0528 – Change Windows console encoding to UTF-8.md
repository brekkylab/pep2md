...
source_path: https://github.com/python/peps/blob/main/peps/pep-0528.rst
source_commit: dc7126104a7887d511dff4086fb82f4c655f56a1
---
...
## Add [io.WindowsConsoleIO]{#io.windowsconsoleio}
...
process_stdinreader.py](https://github.com/twisted/twisted/blob/trunk/src/twisted/test/process_stdinreader.py)).
Code that assumes a particular encoding for the standard streams other
than ASCII will likely break.

## Add [PyOS_WindowsConsoleReadline]{#pyos_windowsconsolereadline}
...
package](https://pypi.org/project/win_unicode_console/) is a pure-Python
alternative to changing the default behaviour of the console. It
implements essentially the same modifications as described here using
pure Python code.
