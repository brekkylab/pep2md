...
source_path: https://github.com/python/peps/blob/main/peps/pep-0201.rst
source_commit: 409b162d7503493e7094d82c6e44bae9f9387ca0
---
...
until the sequence is exhausted[^1]. However, for-loops iterate over
...
comprehensions\' (see `202`{.interpreted-text role="pep"}).
...
- Optional padding. An earlier version of this PEP proposed an optional
  `pad` keyword argument, which would be used when the argument
...
- Inner and outer container control. An earlier version of this PEP
  ...
  version of the PEP). Given the simplified API and implementation, this
  elaboration is rejected. For a more detailed analysis, see version 1.7
  of this PEP.
