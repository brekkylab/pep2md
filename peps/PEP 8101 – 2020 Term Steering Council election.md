...
source_path: https://github.com/python/peps/blob/main/peps/pep-8101.rst
source_commit: 7bf55a8a60333782baff3c41ff7cdb01d3d4f5c2
---
...
`13`{.interpreted-text role="pep"}. This is steering council election
for the 2020 term.
...
Infrastructure, Ee Durbin, to implement the election, and [Python
Software Foundation](https://www.python.org/psf-landing/) Executive
Director, Ewa Jodlowska, to communicate announcements regarding the
election.
