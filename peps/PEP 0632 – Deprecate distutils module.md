...
source_path: https://github.com/python/peps/blob/main/peps/pep-0632.rst
source_commit: 8f0d7ca718d39c37497435a29071e62b324b617b
---
...
thanks to `517`{.interpreted-text role="pep"}.
...
alternative build backend (see `517`{.interpreted-text role="pep"}).
