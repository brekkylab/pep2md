...
source_path: https://github.com/python/peps/blob/main/peps/pep-0576.rst
source_commit: f93a50e55a40a2c5d52fc053ae7f173963c72d43
---
...
`580`{.interpreted-text role="pep"} is an alternative approach to
solving the same problem as this PEP.
