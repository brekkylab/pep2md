...
source_path: https://github.com/python/peps/blob/main/peps/pep-0212.rst
source_commit: e994763646f8d248352242a86cfb3ffa5d9303c8
---

# Rejection Notice

This PEP has been rejected. `enumerate()`, introduced in
`279`{.interpreted-text role="pep"}, covers the use-case proposed in
this PEP, and the PEP author has been unreachable.
...
sequence[^1]. Often it is desirable to loop over the indices or both the
...
[^2]: Lockstep Iteration, `201`{.interpreted-text role="pep"}
