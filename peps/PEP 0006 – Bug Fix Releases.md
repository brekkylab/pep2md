...
source_path: https://github.com/python/peps/blob/main/peps/pep-0006.rst
source_commit: 56ae7970af4f88277797764d35b68a3e112adb4e
---
...
devguide](https://devguide.python.org/developer-workflow/development-cycle/).
See also `101`{.interpreted-text role="pep"} for mechanics of the
release process.
::::
...
releases; they should follow the guidelines in `3`{.interpreted-text
role="pep"}. In general, though, it\'s probably better that a bug in a
specific release also be fixed on the HEAD as well as the branch.
...
requirement (mainly due to the example of `235`{.interpreted-text
role="pep"}, which could be argued as either a bug fix or a feature).
