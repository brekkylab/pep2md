...
source_path: https://github.com/python/peps/blob/main/peps/pep-0227.rst
source_commit: 0baf89db4a3590e2cac160ea0211503d5af8ea67
---
...
adding \"from \_\_future\_\_ import nested_scopes\" to the top of a
module. (See `236`{.interpreted-text role="pep"}.)
...
The changed scoping rules address two problems \-- the limited utility
of lambda expressions (and nested functions in general), and the
frequent confusion of new users familiar with other languages that
support nested lexical scopes, e.g. the inability to define recursive
functions except at the module level.
...
local variables. Modifications to the dictionary do not affect the
values of variables. Under the current rules, the use of `locals()` and
...
[^1]: Luca Cardelli. Compiling a functional language. In Proc. of the
    ...
    Aug. 1984 <https://dl.acm.org/doi/10.1145/800055.802037>
