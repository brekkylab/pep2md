...
source_path: https://github.com/python/peps/blob/main/peps/pep-0404.rst
source_commit: 0153e47521181a4c25e250964af0ebb2f6b72a32
---
...
such tools as [2to3](http://docs.python.org/library/2to3.html) (there\'s
also a non-trivial subset of the language that will run without
modification on both 2.7 and 3.x).
...
You can read in more detail on the
[differences](http://docs.python.org/release/3.0.1/whatsnew/3.0.html)
between Python 2 and Python 3. There are also many good guides on
[porting](http://python3porting.com/) from Python 2 to Python 3.
