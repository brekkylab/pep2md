...
*Note: this PEP was superseded by* `435`{.interpreted-text role="pep"},
*which has been accepted in May 2013.*
...
others, and that operations without meaning (\"Wednesday times two\")
are not defined for these values.
...
[^1]: The `NotImplemented` return value from comparison operations
    signals the Python interpreter to attempt alternative comparisons or
    other fallbacks.
