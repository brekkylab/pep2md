...
source_path: https://github.com/python/peps/blob/main/peps/pep-0293.rst
source_commit: 2df14e0988779cb2f006165719127f8fe23fcac9
---
...
replacement strings (see SF feature request #403100[^1]).
...
it is a system callback like \"strict\", \"replace\" and \"ignore\").
The proposed patch will add two additional system callback names:
...
and `\U` convention, XML supports character references via &#xxx; etc.).
