...
source_path: https://github.com/python/peps/blob/main/peps/pep-3112.rst
source_commit: 7166d7accdbf381befbc8cc7fbe36ed517f981b0
---

# Abstract

This PEP proposes a literal syntax for the `bytes` objects introduced in
`358`{.interpreted-text role="pep"}. The purpose is to provide a
...
- Each `shortstringchar` or `longstringchar` must be a character between
  1 and 127 inclusive, regardless of any encoding declaration[^2] in the
  source file.
