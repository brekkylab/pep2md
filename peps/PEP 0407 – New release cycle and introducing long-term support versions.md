...
source_path: https://github.com/python/peps/blob/main/peps/pep-0407.rst
source_commit: bf6d5c2f79cd15dd4b701d4fd95d7b8d97f7248c
---
...
- Restrict new syntax and similar changes (i.e. everything that was
  prohibited by `3003`{.interpreted-text role="pep"}) to LTS versions?
