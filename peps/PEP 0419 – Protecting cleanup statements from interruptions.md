...
source_path: https://github.com/python/peps/blob/main/peps/pep-0419.rst
source_commit: f464a2d9f86fb234f962d0d20e6c8000b3c09b3c
---
...
If `KeyboardInterrupt` occurs near any of the `print()` calls, the lock
...
exactly what\'s intended. So some hidden interpreter logic may be used
to put a `__context__` attribute on every exception raised in a cleanup
hook.
...
- Cleanup may take too much time, not giving user a chance to interrupt
  an application.
