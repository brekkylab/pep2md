...
source_path: https://github.com/python/peps/blob/main/peps/pep-0274.rst
source_commit: cd4ca9bc068bc3dad768b9f5bd015867919cc1de
---

# Abstract

`202`{.interpreted-text role="pep"} introduces a syntactical extension
to Python called the \"list comprehension\". This PEP proposes a similar
syntactical extension called the \"dictionary comprehension\" or \"dict
comprehension\" for short. You can use dict comprehensions in ways very
similar to list comprehensions, except that they produce Python
dictionary objects instead of list objects.
