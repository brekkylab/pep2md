...
source_path: https://github.com/python/peps/blob/main/peps/pep-0476.rst
source_commit: 51788e71ccebe04a427128f6ac1c3f44dc6a38a1
---
...
matter is a source of *regular* CVE
...
actually verify that the user\'s request has been made is a bug,
further: \"Errors should never pass silently.\"
...
already backported in `466`{.interpreted-text role="pep"}.

# Implementation

- **LANDED**: [Issue 22366](http://bugs.python.org/issue22366) adds the
  `context` argument to `urlib.request.urlopen`.
- [Issue 22417](http://bugs.python.org/issue22417) implements the
