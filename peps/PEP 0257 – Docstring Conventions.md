...
source_path: https://github.com/python/peps/blob/main/peps/pep-0257.rst
source_commit: 9ef667588c3d57b35eb4eb32642b7e7acc6815c3
---
...
looks. But some software (such as the
[Docutils](https://docutils.sourceforge.io/) docstring processing system
`256`{.interpreted-text role="pep"}, `258`{.interpreted-text
role="pep"}) will be aware of the conventions, so following them will
...
Please see `258`{.interpreted-text role="pep"}, \"Docutils Design
Specification\", for a detailed description of attribute and additional
docstrings.
...
- The one-line docstring should NOT be a \"signature\" reiterating the
  ...
  should be mentioned. The preferred form for such a docstring would be
  something like:
...
The \"Specification\" text comes mostly verbatim from
`8`{.interpreted-text role="pep"} by Guido van Rossum.
