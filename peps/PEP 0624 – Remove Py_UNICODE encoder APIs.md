...
source_path: https://github.com/python/peps/blob/main/peps/pep-0624.rst
source_commit: abe7075d42ccee672e8ef22252a7fbce854896a4
---
...
`623`{.interpreted-text role="pep"} propose to remove Unicode object
APIs relating to `Py_UNICODE`. On the other hand, this PEP is not
relating to Unicode object. These PEPs are split because they have
...
- [\[python-dev\] Plan to remove Py_UNICODE APis except PEP
...
- [bpo-41123: Remove Py_UNICODE APIs except PEP
  623](https://bugs.python.org/issue41123)
- [\[python-dev\] PEP 624: Remove Py_UNICODE encoder
  APIs](https://mail.python.org/archives/list/python-dev@python.org/thread/THXVM7FZVT56B7CPEDIYKJG6VMAYIEK5/#QUGBVLQNBFVNX25AEIL77WSFOHQES6LJ)
...
- Why not remove decoder APIs too?
  ...
  - Decoder APIs can decode from byte buffer directly, without creating
    temporary bytes object. On the other hand, encoder APIs can not
    avoid temporary Unicode object.
