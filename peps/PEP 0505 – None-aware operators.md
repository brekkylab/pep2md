...
source_path: https://github.com/python/peps/blob/main/peps/pep-0505.rst
source_commit: e2c155b7a8ee93d137aea102b7dc5e5ae6d6ef65
---
...
dot get_value or 100 if None\", or \"call a dot get_value coalesced with
100\".
...
The next example is from a Python scraping library called
[Grab](https://github.com/lorien/grab/blob/4c95b18dcb0fa88eeca81f5643c0ebfb114bf728/grab/upload.py):
...
rejected, see their treatment in `531`{.interpreted-text role="pep"} and
`532`{.interpreted-text role="pep"} and the associated discussions.
...
to be coalesced just like `None`. For example, the `pyasn1` package has
a type called `Null` that represents an ASN.1 `null`:
...
operator. Here is an excerpt from the popular [Requests
package](https://github.com/kennethreitz/requests/blob/14a555ac716866678bf17e43e23230d81a8149f5/requests/models.py#L212):
