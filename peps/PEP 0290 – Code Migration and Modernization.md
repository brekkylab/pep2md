...
source_path: https://github.com/python/peps/blob/main/peps/pep-0290.rst
source_commit: fceb6aeade3389d4fdd9abde68ba1932befc6072
---
...
are slowly deprecated according to the guidelines in
`4`{.interpreted-text role="pep"}. Also, some code relies on
undocumented behaviors which are subject to change between versions.
Some code may rely on behavior which was subsequently shown to be a bug
and that behavior changes when the bug is fixed.
...
Locating: Use [PyChecker](http://pychecker.sourceforge.net/).
