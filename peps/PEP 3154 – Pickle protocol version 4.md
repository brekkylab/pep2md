...
python_version: '3.4'
post_history:
- '`12-Aug-2011 <https://mail.python.org/pipermail/python-dev/2011-August/112821.html>`__'
resolution: https://mail.python.org/pipermail/python-dev/2013-November/130439.html
python_status: Final
url: https://peps.python.org/pep-3154/
source_path: https://github.com/python/peps/blob/main/peps/pep-3154.rst
source_commit: e086a05439e970d6bbc095e58928e973bfca4836
---
...
\"text\" mode of the pickle protocol, which involves looking for
newlines in the pickle stream. It also complicates the implementation of
binary framing.
...
The `__qualname__` attribute from `3155`{.interpreted-text role="pep"}
makes it possible to lookup many more objects by name. Making the
STACK_GLOBAL opcode accept dot-separated names would allow the standard
pickle implementation to support all those kinds of objects.
...
- Alexandre Vassalotti, for starting the second `3154`{.interpreted-text
  role="pep"} implementation[^6]
- Serhiy Storchaka, for discussing the framing proposal[^7]
- Stefan Mihaila, for starting the first `3154`{.interpreted-text
  role="pep"} implementation as a Google Summer of Code project mentored
  by Alexandre Vassalotti[^8].
...
[^5]: \"pickle/copyreg doesn\'t support keyword only arguments in
    \_\_new\_\_\": <http://bugs.python.org/issue4727>
