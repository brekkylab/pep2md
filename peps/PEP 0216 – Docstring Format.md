...
::: withdrawn
It has been superseded by `287`{.interpreted-text role="pep"}.
:::
...
Old Documentation. This is an easy-to-type, very low level format which
...
a.  A tag that means \"this is a Python *something*, guess what\"
    ...
    Example: In the sentence \"The POP3 class\", we need to markup
    \"POP3\" so. The parser will be able to guess it is a class from the
    contents of the `poplib` module, but we need to make it guess.
