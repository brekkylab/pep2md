...
source_path: https://github.com/python/peps/blob/main/peps/pep-8010.rst
source_commit: 1fb7be064764ae8c525666310795a727f262926a
---
...
will be codified in `13`{.interpreted-text role="pep"} along with the
names of all officeholders described in this PEP.

# PEP Rejection

`8010`{.interpreted-text role="pep"} was rejected [by a core developer
...
the voting method specified in `8001`{.interpreted-text role="pep"},
although as that PEP is still in discussion at the time of this writing,
...
described in `8001`{.interpreted-text role="pep"}.
...
voting is done by the same procedure as in `8001`{.interpreted-text
role="pep"}, and all core developers may participate in no confidence
votes.
...
> - The adoption of `8001`{.interpreted-text role="pep"} voting
>   procedures is tentative until that PEP is approved
