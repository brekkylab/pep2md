...
source_path: https://github.com/python/peps/blob/main/peps/pep-0224.rst
source_commit: fcc336d985bc9bd9c54c7bc7e5636eb39a674ab6
---

::: rejected
See `224-rejection`{.interpreted-text role="ref"} for more information.
:::
...
# Comments from our BDFL {#224-rejection}

Early comments on the PEP from Guido:

> I \"kinda\" like the idea of having attribute docstrings (meaning
> it\'s not of great importance to me) but there are two things I don\'t
> like in your current proposal:
>
...
>     b = 1
>
> I really have no way to know whether \"foo bar\" is a docstring for a
> or for b.
>
> \...
>
