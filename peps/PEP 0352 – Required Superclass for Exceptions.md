...
source_path: https://github.com/python/peps/blob/main/peps/pep-0352.rst
source_commit: 2b6674cb0a5221f2f49d8cbcc3737c688459791e
---
...
This PEP is based on previous work done for `348`{.interpreted-text
role="pep"}.
...
Python 2.x is covered in the [Transition Plan](#transition-plan)
section):
...
starting in Python 3.0 (see the [Transition Plan](#transition-plan)
below).
...
- Python 2.6 \[done\]
  ...
  - deprecate `message` attribute (see [Retracted
    Ideas](#retracted-ideas)) \[done\]
- Python 2.7 \[done\]
...
- Issue for new-style exceptions:
  [python/cpython#41459](https://github.com/python/cpython/issues/41459)
