...
source_path: https://github.com/python/peps/blob/main/peps/pep-0591.rst
source_commit: 03d09d6cda53343e17191a7299b389802b8ccbdb
---

::: canonical-typing-spec
`typing:at-final`{.interpreted-text
role="ref"}/`@typing.final <typing.final>`{.interpreted-text
role="py:func"} and `typing:uppercase-final`{.interpreted-text
role="ref"}/`typing.Final`{.interpreted-text role="py:data"}
:::
...
- Allowing a name to be used in situations where ordinarily a literal is
  ...
  arguments of `Literal` type (`586`{.interpreted-text role="pep"})).
