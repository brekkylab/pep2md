...
source_path: https://github.com/python/peps/blob/main/peps/pep-0261.rst
source_commit: 81b5cd7fbf7043ac1bd4e39dff80dca75e33a43b
---
...
:   A Python type representing a sequence of code points with \"string
    semantics\" (e.g. case conversions, regular expression
...
- There is an integer value in the sys module that describes the largest
  ordinal for a character in a Unicode string on the current
...
- codecs will be upgraded to support \"wide characters\" (represented
  ...
  UTF-16). This is the main part of the implementation left to be done.

- There is a convention in the Unicode world for encoding a 32-bit code
  point in terms of two 16-bit code points. These are known as
  \"surrogate pairs\". Python\'s codecs will adopt this convention and
  encode 32-bit code points as surrogate pairs on narrow Python builds.
...
> \"emulate\" wide Python semantics on narrow Python. Guido is not
> willing to undertake the implementation right now.
