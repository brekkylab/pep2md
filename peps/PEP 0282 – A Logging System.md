...
source_path: https://github.com/python/peps/blob/main/peps/pep-0282.rst
source_commit: f68d447086e713a7dfd39e6562689c3d22a6d93e
---
...
logging is more likely to be done \'well\', and 2) multiple libraries
will be able to be integrated into larger applications which can be
logged reasonably coherently.
...
this case, the file name passed to the constructor is taken as a
\"base\" file name. Additional file names for the rotation are created
by appending .1, .2, etc. to the base file name, up to a maximum as
...
one particular area of an application; the focus can be changed simply
by changing a filter attached to the root logger.
...
The reference implementation[^9] has a working configuration file
