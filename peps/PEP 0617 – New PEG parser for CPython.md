...
source_path: https://github.com/python/peps/blob/main/peps/pep-0617.rst
source_commit: 4d146c6b1226ef08da666fde04a40002b2316a82
---

::: canonical-doc
`python:full-grammar-specification`{.interpreted-text role="ref"}
:::
...
The current Python grammar does not contain ε-productions, so the
...
across lines](https://github.com/python/cpython/issues/56991) shows how
making an LL(1) rule that supports writing:
...
- A PEG meta-grammar that automatically generates a Python parser that
  is used for the parser generator itself (this means that there are no
...
- Compiling and throwing away the internal AST took 2.141 seconds.
  That\'s 350,040 lines/sec, or 12,899,367 bytes/sec. The max RSS was 74
  MiB (the largest file in the stdlib is much smaller than our canonical
  test file).
