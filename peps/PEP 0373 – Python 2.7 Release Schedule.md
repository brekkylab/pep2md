...
source_path: https://github.com/python/peps/blob/main/peps/pep-0373.rst
source_commit: 929dacd3b2738590ad2b4db52ea9830d8ca4e397
---
...
Python 3. See [the \"Sunsetting Python 2\" FAQ on
python.org](https://www.python.org/doc/sunset-python-2/) for a general
overview.
...
yet migrate to Python 3. See also `466`{.interpreted-text role="pep"}.
...
There will be no Python 2.8 (see `404`{.interpreted-text role="pep"}).
...
- [\"The Python 2 death march\" on
  python-dev](https://mail.python.org/archives/list/python-dev@python.org/thread/APWHFYQDKNVYQAK3HZMBGQIZHAVRHCV2/)
- [Petition: abandon plans to ship a 2.7.18 in
  April](https://discuss.python.org/t/petition-abandon-plans-to-ship-a-2-7-18-in-april/2946/)
- [\[RELEASE\] Python 2.7.18, the end of an
  era](https://mail.python.org/archives/list/python-announce-list@python.org/thread/OFCIETIXLX34X7FVK5B5WPZH22HXV342/)
