...
source_path: https://github.com/python/peps/blob/main/peps/pep-8014.rst
source_commit: 060b7c161423f5a055cd0e094cf08096061495b9
---
...
`8014`{.interpreted-text role="pep"} was rejected [by a core developer
...
- the measurable vote results (how many people voted, which individuals
  voted, what they voted).
...
- Most of the actual work is to be done by the PEP author and the
  community, the Council of Elders does not organize the vote and tally
  the results.

- The idea behind the first tentative decision is mistakes by the
  Council of elders (misjudging how far-reaching a PEP is, most likely)
  are not fatal, because the community has a chance to point out these
  mistakes.
  ...
  correct them. Getting seven hard-working professionals together every
  two weeks, even by email, may be a bit much to ask.
...
PEP like `572`{.interpreted-text role="pep"} will pass if this model is
in place.
