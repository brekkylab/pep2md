...
source_path: https://github.com/python/peps/blob/main/peps/pep-0504.rst
source_commit: ed00690874c203a07eded3ed51af1374b2585a5f
---
...
developers that aren\'t aware that they\'re doing security sensitive
work use the default module level APIs, and thus expose their users to
unnecessary risks.

This isn\'t an acute problem, but it is a chronic one, and the often
long delays between the introduction of security flaws and their
exploitation means that it is difficult for developers to naturally
...
refining Steven\'s proposal as `506`{.interpreted-text role="pep"}.
...
internet[^4] simply doesn\'t take the mathematical arcana of computer
security into account. Compounding these issues is the fact that
defenders have to cover *all* of their potential vulnerabilities, as a
single mistake can make it possible to subvert other defences[^5].
...
what you\'re doing is incorrect is for someone reviewing your code to
say \"that\'s a potential security problem\", or for a system you\'re
...
fatigue\", where developers (often rightly[^6]) feel that security
engineers spend all their time saying \"don\'t do that the easy way, it
creates a security vulnerability\".

As the designers of one of the world\'s most popular languages[^7], we
can help reduce that problem by making the easy way the right way (or at
...
right thing to do, and in many cases, these software models won\'t have
a dedicated maintenance team tasked with ensuring they keep working on
...
The original discussion of this proposal on python-ideas[^8] suggested
...
The problem[^9] with this approach is that it introduces an additional
...
While we\'re not currently aware of any studies of Python\'s random
number generator specifically, studies of PHP\'s random number
generator[^10] have demonstrated the ability to use weaknesses in that
...
initial draft concept posted to python-ideas[^11].
...
- Donald Stufft for pursuing additional discussions with network
  security experts that suggested the introduction of a userspace CSPRNG
  would mean additional complexity for insufficient gain relative to
  just using the system RNG directly
...
[^4]: Search link for \"python password generator\"
    (<https://www.google.com.au/search?q=python+password+generator>)

[^5]: Bypassing bcrypt through an insecure data cache
    (<http://arstechnica.com/security/2015/09/once-seen-as-bulletproof-11-million-ashley-madison-passwords-already-cracked/>)

[^6]: OWASP Top Ten Web Security Issues for 2013
    (<https://www.owasp.org/index.php/OWASP_Top_Ten_Project#tab=OWASP_Top_10_for_2013>)

[^7]: IEEE Spectrum 2015 Top Ten Programming Languages
    (<http://spectrum.ieee.org/computing/software/the-2015-top-ten-programming-languages>)

[^8]: python-ideas thread discussing using a userspace CSPRNG
    (<https://mail.python.org/pipermail/python-ideas/2015-September/035886.html>)

[^9]: Safely generating random numbers
    (<http://sockpuppet.org/blog/2014/02/25/safely-generate-random-numbers/>)

[^10]: PRNG based attack against password reset tokens in PHP
    applications
    (<https://media.blackhat.com/bh-us-12/Briefings/Argyros/BH_US_12_Argyros_PRNG_WP.pdf>)

[^11]: Initial draft concept that eventually became this PEP
