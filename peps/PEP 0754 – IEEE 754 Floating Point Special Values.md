...
source_path: https://github.com/python/peps/blob/main/peps/pep-0754.rst
source_commit: 7d3596af35118388d2e7647b4785b0b1926ddd63
---
...
instance, on some systems \"float(\'Inf\')\" will properly return the
IEEE 754 constant for positive infinity. On many systems, however, this
...
\>\>\> import fpconst \>\>\> val = 1e30000 \# should be cause overflow
and result in \"Inf\" \>\>\> val Infinity \>\>\> fpconst.isInf(val) 1
\>\>\> fpconst.PosInf Infinity \>\>\> nval = val/val \# should result in
NaN \>\>\> nval NaN \>\>\> fpconst.isNaN(nval) 1 \>\>\>
fpconst.isNaN(val) 0
