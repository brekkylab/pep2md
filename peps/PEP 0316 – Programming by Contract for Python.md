...
source_path: https://github.com/python/peps/blob/main/peps/pep-0316.rst
source_commit: 03597afcf8f9fe97af6ee900f2f8bb51b6fbb694
---
...
module[^2]. Documentation is readable by programmers, yet has executable
tests embedded in it.

Testing code with contracts is easier too. Comprehensive contracts are
equivalent to unit tests[^3]. Tests exercise the full range of
...
docstrings written using reStructuredText[^4]. For example, the
...
mirrors the Eiffel DBC specification[^5].
...
`__old__` much easier. It also is more in line with Z schemas[^6], which
are divided into two parts: declaring what changes followed by limiting
the changes.
...
A reference implementation is available[^7]. It replaces existing
functions with new functions that do contract checking, by directly
changing the class\' or module\'s namespace.

Other implementations exist that either hack `__getattr__`[^8] or use
`__metaclass__`[^9].
...
[^1]: Design By Contract is a registered trademark of Eiffel Software
    Inc. (<http://archive.eiffel.com/doc/manuals/technology/contract/>)

[^2]: <http://docs.python.org/library/doctest.html> doctest \-- Test
    docstrings represent reality

[^3]: Extreme Programming Explained, Kent Beck, ISBN 0-201-61641-6

[^4]: ReStructuredText (<http://docutils.sourceforge.net/rst.html>)

[^5]: Object-oriented Software Construction, Bertrand Meyer, ISBN
    0-13-629031-0

[^6]: The Z Notation, Second Edition, J.M. Spivey ISBN 0-13-978529-9

[^7]: Implementation described in this document.
    (<http://www.wayforward.net/pycontract/>)

[^8]: Design by Contract for Python, R. Plosch *IEEE Proceedings of the
    Joint Asia Pacific Software Engineering Conference (APSEC97/ICSC97),
    Hong Kong, December 2-5, 1997*
    (<http://www.swe.uni-linz.ac.at/publications/abstract/TR-SE-97.24.html>)

[^9]: PyDBC \-- Design by Contract for Python 2.2+, Daniel Arbuckle
