...
in the 2.x series. Examples are names like \"StringIO\" or \"Cookie\".
For Python 3000, there will be the possibility to give those modules
less confusing and more conforming names.
...
modules (such as a \"\_\_version\_\_\" global). Those could be
standardized and used throughout the library.
