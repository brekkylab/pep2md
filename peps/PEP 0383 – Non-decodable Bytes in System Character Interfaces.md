...
source_path: https://github.com/python/peps/blob/main/peps/pep-0383.rst
source_commit: 8f030b645777d7c6c3c53152964e93bf8d7306bb
---
...
data to Python str objects (`277`{.interpreted-text role="pep"}).
...
To convert non-decodable bytes, a new error handler
(`293`{.interpreted-text role="pep"}) \"surrogateescape\" is introduced,
which produces these surrogates. On encoding, the error handler converts
the surrogate back to the corresponding byte. This error handler will be
used in any API that receives or produces file names, command line
