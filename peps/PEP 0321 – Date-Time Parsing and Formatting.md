...
source_path: https://github.com/python/peps/blob/main/peps/pep-0321.rst
source_commit: cf5a579b0984c3a470fca8dd97307f82e4cf2fa7
---
...
- ARPA/`2822`{.interpreted-text role="rfc"}
- [ctime](http://www.opengroup.org/onlinepubs/007908799/xsh/asctime.html)
...
XXX The Perl
[ParseDate.pm](http://search.cpan.org/author/MUIR/Time-modules-2003.0211/lib/Time/ParseDate.pm)
module supports many different input formats, both absolute and
relative. Should we try to support them all?
...
supported; `2822`{.interpreted-text role="rfc"} is currently the only
one I can think of.
...
Relevant functionality in other languages includes the [PHP
date](http://www.php.net/date) function (Python implementation by Simon
Willison at <http://simon.incutio.com/archive/2003/10/07/dateInPython>)
