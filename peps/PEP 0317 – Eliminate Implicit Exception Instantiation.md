...
source_path: https://github.com/python/peps/blob/main/peps/pep-0317.rst
source_commit: 025a2d3c1c96d4da18365da8f2305b32d18de7c8
---
...
the guidelines of `5`{.interpreted-text role="pep"}.)
...
> the \"compatibility forms\" of the raise statement \[\...\] The
...
Under the `236`{.interpreted-text role="pep"} future statement:
...
Three new `warnings <230>`{.interpreted-text role="pep"}, all of
category `DeprecationWarning`, are to be issued to point out uses of
`raise` which will become incorrect under the proposed changes.
