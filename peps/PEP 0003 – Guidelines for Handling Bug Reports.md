...
source_path: https://github.com/python/peps/blob/main/peps/pep-0003.rst
source_commit: 62295773e99109b13c37bc5bd439c257d059b902
---
...
issue triaging](https://devguide.python.org/triage/triaging/index.html).
Guidelines for people submitting Python bugs are [in the Python
docs](http://docs.python.org/bugs.html).
:::
...
2.  If it\'s a minor feature request that you don\'t plan to address
    right away, add it to `42`{.interpreted-text role="pep"} or ask the
    owner to add it for you. If you add the bug to
    `42`{.interpreted-text role="pep"}, mark the bug as \"feature
...
3.  Assign the bug a reasonable priority. We don\'t yet have a clear
    ...
    bugs with priority \"urgent\" or higher must be fixed before the
    next release.
