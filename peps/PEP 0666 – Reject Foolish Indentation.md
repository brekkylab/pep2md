...
source_path: https://github.com/python/peps/blob/main/peps/pep-0666.rst
source_commit: 9bd8e4ef166af662bc5649926b895926d5f7292e
---
...
valuable time and mine.\' People who are already in the middle of a
flame war are not well disposed to believe that you are acting out of
...
with idiots, (which is something the arguers could do [now]{#now}\_, but
...
to know the answer to that question[^1].
...
[^1]: Tim Peters already has (private correspondence). My early 2.2
    didn\'t have a `__getattribute__`, and `__getattr__` was implemented
    like `__getattribute__` now is. This has been fixed. The important
    conclusion is that my Decorator Pattern is safe and all is right
    with the world.
