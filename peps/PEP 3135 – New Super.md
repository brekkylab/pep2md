...
source_path: https://github.com/python/peps/blob/main/peps/pep-3135.rst
source_commit: c53b7ade6fdb714d67f1eafedff9b0fbf2b6e040
---

# Numbering Note

This PEP started its life as `367`{.interpreted-text role="pep"}. Since
it is now targeted for Python 3000, it has been moved into the 3xxx
space.
...
to distinguish similar and closely related concepts. \"super class\"
will refer to the actual builtin class named \"super\". A \"super
instance\" is simply an instance of the super class, which is associated
