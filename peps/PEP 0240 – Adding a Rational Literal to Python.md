...
source_path: https://github.com/python/peps/blob/main/peps/pep-0240.rst
source_commit: 4768cf13ad60c2c5b3695edea4c19764bba2def8
---

# Abstract

A `different PEP <239>`{.interpreted-text role="pep"} suggests adding a
builtin rational type to Python. This PEP suggests changing the ddd.ddd
float literal to a rational in Python, and modifying non-integer
division to return it.

# BDFL Pronouncement

This PEP is rejected. The needs outlined in the rationale section have
been addressed to some extent by the acceptance of
`327`{.interpreted-text role="pep"} for decimal arithmetic. Guido also
...
<tutor@python.org> have shown, people often get bit by strange semantics
