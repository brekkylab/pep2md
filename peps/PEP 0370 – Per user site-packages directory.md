...
source_path: https://github.com/python/peps/blob/main/peps/pep-0370.rst
source_commit: deedd91a20f98a89a2bfdc19503230d896159417
---
...
value \"%HOMEDRIVE%%HOMEPATH%Applicata Data\". Users should consult
their local administrator for more information.[^7]
...
On Mac OS X Python uses \~/.local directory as well.[^10] Framework
...
after Python\'s search paths and `PYTHONPATH`. This setup allows the
...
process uid / gid[^11]. It\'s an additional barrier against code
