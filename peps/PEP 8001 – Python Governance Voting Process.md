...
source_path: https://github.com/python/peps/blob/main/peps/pep-8001.rst
source_commit: 342660dbe212bebb5c0c8fbcc965a4418cecd026
---
...
codified in `13`{.interpreted-text role="pep"}.
...
the Python project. The list of candidate PEPs is listed in
`8000`{.interpreted-text role="pep"} and consists of all PEPs numbered
in the 801X range.
...
The election will be supervised by Ee Durbin, The PSF Director of
Infrastructure.
...
- Voters will *not* have the ability to change their vote after casting
  a ballot. [\[no-changes\]](#no-changes){.citation}
- The default ordering for each ballot will be randomized to remove any
  influence that the order of the ballot may have on the election.
...
administrator can influence the election can be found
