...
source_path: https://github.com/python/peps/blob/main/peps/pep-0222.rst
source_commit: f0955163986dc422d07db199519b920dd6359251
---
...
- fcgi.py : A new module adding support for the FastCGI protocol. Robin
  Dunn\'s code needs to be ported to Windows, though.
...
- An HTML generation module is not part of this PEP. Several such
  modules exist, ranging from HTMLgen\'s purely programming interface to
  ASP-inspired simple templating to DTML\'s complex templating. There\'s
  no indication of which templating module to enshrine in the standard
  library, and that probably means that no module should be so chosen.
