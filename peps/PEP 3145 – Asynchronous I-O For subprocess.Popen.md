...
source_path: https://github.com/python/peps/blob/main/peps/pep-3145.rst
source_commit: e5ca52a8f069885d6f166f1394cda41d18da0bb7
---
...
deferred at least until after `3156`{.interpreted-text role="pep"} has
been resolved.
...
instead of blocking to wait for the program to produce data[^2][^3][^4].
The current behavior of the `subprocess` module is that when a user
sends or receives data via the stdin, stderr and stdout file objects,
dead locks are common and documented[^5][^6]. While communicate can be
used to alleviate some of the buffering issues, it will still cause the
...
in `subprocess.Popen`[^7][^8][^9][^10]. Inclusion of the code would
...
Python has a file-like wrapper of some sort. Sockets already act as such
and for strings there is `StringIO`. Popen can be made to act like a
file by simply using the methods attached to the
...
changes including tests and documentation[^11] as well as blog detailing
the problems I have come across in the development process[^12].
...
[^1]: <https://github.com/python/cpython/issues/63023> \-- Idle: use
    pipes instead of sockets to talk with user subprocess

[^2]: \[ python-Feature Requests-1191964 \] asynchronous Subprocess
    <https://mail.python.org/pipermail/python-bugs-list/2006-December/036524.html>

[^3]: Daily Life in an Ivory Basement : /feb-07/problems-with-subprocess
    <http://ivory.idyll.org/blog/problems-with-subprocess.html>

[^4]: How can I run an external command asynchronously from Python? -
    Stack Overflow <https://stackoverflow.com/q/636561>
...
[^6]: 18.1. subprocess - Subprocess management - Python v2.6.2
    documentation
    <https://docs.python.org/2.6/library/subprocess.html#subprocess.Popen.kill>

[^7]: Issue 1191964: asynchronous Subprocess - Python tracker
    <https://github.com/python/cpython/issues/41922>

[^8]: Module to allow Asynchronous subprocess use on Windows and Posix
    platforms - ActiveState Code
    <https://code.activestate.com/recipes/440554/>

[^9]: Daily Life in an Ivory Basement : /feb-07/problems-with-subprocess
    <http://ivory.idyll.org/blog/problems-with-subprocess.html>

[^10]: How can I run an external command asynchronously from Python? -
    Stack Overflow <https://stackoverflow.com/q/636561>

[^11]: subprocdev - Project Hosting on Google Code
    <https://code.google.com/archive/p/subprocdev/>

[^12]: Python Subprocess Dev <https://subdev.blogspot.com/>
