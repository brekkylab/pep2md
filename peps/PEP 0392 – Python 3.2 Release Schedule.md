...
source_path: https://github.com/python/peps/blob/main/peps/pep-0392.rst
source_commit: 5ccb6864329363cdca7542b7279a908d5bf37c17
---
...
Note that `3003`{.interpreted-text role="pep"} is in effect: no changes
to language syntax and no additions to the builtins may be made.
