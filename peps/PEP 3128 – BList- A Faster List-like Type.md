...
source_path: https://github.com/python/peps/blob/main/peps/pep-3128.rst
source_commit: 008d9e2a4efb8e75987cb238428016c961186e2e
---
...
of needing a fast FIFO queue. However, the deque type doesn\'t help if
we need to repeatedly insert or delete elements from the middle of a
long list.
...
A reference implementations of the BList is available for CPython
at[^3].
...
- Con: The use cases where BLists are slower are important (see [Use
  Case Trade-Offs](#use-case-trade-offs) for how these might be
  addressed).
...
(now available at[^5]). If it proves useful, he felt it would be a
