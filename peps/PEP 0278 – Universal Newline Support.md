...
source_path: https://github.com/python/peps/blob/main/peps/pep-0278.rst
source_commit: fcd75fba2471d7e95b20e9d8196bc5e2e11545cd
---
...
can also be \"U\", meaning \"open for input as a text file with
universal newline interpretation\". Mode \"rU\" is also allowed, for
symmetry with \"rb\". Mode \"U\" cannot be combined with other mode
flags such as \"+\". Any line ending in the input file will be seen as a
`'\n'` in Python, so little other code has to change to handle universal
newlines.
...
- Compatibility. Programs which already do their own interpretation of
  ...
  would silently convert your line endings to the local convention on
  save. Programs which open binary files as text files on Unix would
  also break (but it could be argued they deserve it :-).
