...
source_path: https://github.com/python/peps/blob/main/peps/pep-0009.rst
source_commit: fd76dc3ec19a382c2625a6ea6ec700cba5cf4560
---

::: withdrawn
As of 05-Jan-2016, this PEP is officially deprecated and replaced by
`12`{.interpreted-text role="pep"}. All PEPs should now use the
reStructuredText format described by `12`{.interpreted-text role="pep"},
and plaintext PEPs will no longer be accepted.
:::
