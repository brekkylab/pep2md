...
source_path: https://github.com/python/peps/blob/main/peps/pep-3114.rst
source_commit: c6d5f4b21eaf20bf0951db6aa082fa2143509f50
---
...
the BDFL on python-dev[^1] and is even mentioned in the original
iterator PEP, `234`{.interpreted-text role="pep"}:
...
[^2]: PEP: rename it.next() to it.\_\_next\_\_()\... (Martin von Loewis)
...
[^6]: PEP: rename it.next() to it.\_\_next\_\_()\... (Guido van Rossum)
