...
- *close it* if blocking concerns are not solvable. When an RFC is
  marked as *closed*, there is a 7-day grace period to debate whether it
  should be closed.
...
1](https://github.com/django/deps/blob/main/final/0001-dep-process.rst).
...
[CONTRIBUTING.md](https://github.com/Microsoft/TypeScript/blob/main/CONTRIBUTING.md)
